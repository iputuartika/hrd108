        ...
        <div class="flex justify-between pt-5">
            ...
            <div class="flex items-center flex-shrink-0 space-x-6">
                ...
                <div class="relative">
                    ...
                    <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">{{ count($notifs) }}</div>
                    </button>
                </div>
                <!-- Dropdown menu -->
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <div class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <div class="w-full pl-3">
                                <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"> {{ $notif['nama'] }} <span class="font-semibold text-gray-900 dark:text-white">:</span> {{ $notif['lama'] }}</div>
