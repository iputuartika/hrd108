...
@php
    ...
    switch ($variant) {
        ...
        break;
        case 'success':
            $variantClasses = 'bg-green-500 text-white hover:bg-green-600 focus:ring-transparent dark:focus:ring-gray-800';
        break;
        case 'danger':
        ...
        break;
        default:
            $variantClasses = 'bg-blue-500 text-white hover:bg-blue-600 focus:ring-transparent dark:focus:ring-transparent';
    }
