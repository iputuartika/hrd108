<nav
    ...
    <div class="flex items-center gap-3">
        <x-button
            type="button"
            class="md:hidden bg-gray-600 hover:bg-gray-700 dark:bg-amber-300 dark:hover:bg-amber-400"
            icon-only
            variant="default"
    ...
    <div class="flex items-center gap-3">
        <x-button
            type="button"
            class="hidden md:inline-flex bg-gray-600 hover:bg-gray-700 dark:bg-amber-300 dark:hover:bg-amber-400"
            icon-only
            variant="default"
            sr-text="Toggle dark mode"
            x-on:click="toggleTheme"
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center p-2 text-sm font-medium text-gray-500 rounded-md transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none focus:ring focus:ring-white dark:focus:ring-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                >
